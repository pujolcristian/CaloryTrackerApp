...
fun ActivityScreen(
    ...
    Box(
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = { viewModel.onEvent(event = ActivityEvent.OnActivityClick(ActivityLevel.Low)) }
                )
                ...
                SelectableButton(
                    ...
                    onClick = { viewModel.onEvent(event = ActivityEvent.OnActivityClick(ActivityLevel.Medium)) }
                )
                ...
                SelectableButton(
                    ...
                    onClick = { viewModel.onEvent(event = ActivityEvent.OnActivityClick(ActivityLevel.High)) }
                )
            }
        }
        ...
        ActionButton(
            ...
            onClick = { viewModel.onEvent(event = ActivityEvent.OnNextClick) }
        )
    }
}
