        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = { viewModel.onEvent(event = GenderEvent.OnGenderClick(Gender.Male)) }
                )
                ...
                SelectableButton(
                    ...
                    onClick = { viewModel.onEvent(event = GenderEvent.OnGenderClick(Gender.Female)) }
                )
            }
        }
        ActionButton(
            ...
            onClick = { viewModel.onEvent(event = GenderEvent.OnNextClick) }
        )
    }
}
