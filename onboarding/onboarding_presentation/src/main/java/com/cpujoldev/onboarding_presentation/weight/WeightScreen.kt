...
import com.cpujoldev.onboarding_presentation.components.UnitTextField
    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = { viewModel.onEvent(WeightEvent.OnWeightChange(weight = it)) },
                unit = stringResource(id = R.string.kg)
            )
        }
        ActionButton(
            text = stringResource(id = R.string.next),
            onClick = { viewModel.onEvent(WeightEvent.OnNextClick) },
